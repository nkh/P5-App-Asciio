...
# mouse
'Mouse right-click'                                    => ['000-button_press-3',          \&App::Asciio::Actions::Mouse::mouse_right_click                               ],

'Mouse left-click'                                     => ['000-button_press-1',          \&App::Asciio::Actions::Mouse::mouse_left_click                                ],
'Mouse shift-left-click'                               => ['00S-button_press-1',          \&App::Asciio::Actions::Mouse::mouse_shift_left_click                          ],
'Mouse ctl-left-click'                                 => ['C00-button_press-1',          \&App::Asciio::Actions::Mouse::mouse_ctl_left_click                            ],
