...
'<< change color/font leader >>'=> 
	...
	'Show/hide binding completion'        => ['000-b', sub { $_[0]->{USE_BINDINGS_COMPLETION} ^= 1 ; $_[0]->update_display() ;}                 ],
...
'<< git leader >>' =>
	...
	'Show git bindings'              => ['00S-question',                        sub { $_[0]->create_binding_completions(1) ; }                         ],
