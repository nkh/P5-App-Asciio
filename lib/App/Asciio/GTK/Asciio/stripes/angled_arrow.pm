...
my $model = Gtk3::ListStore->new(qw/Glib::String Glib::String Glib::String  Glib::String  Glib::String Glib::String Glib::String Glib::String Glib::Boolean/);
...
my $current_column = 1 ;
for my $column_title('start', 'body', 'connection', 'body_2', 'end', 'vertical', 'diagonal_connection')
	{
